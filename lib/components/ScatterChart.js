...
var ScatterChart = (function(_React$Component) {
    ...
    _createClass(ScatterChart, [
        ...
        {
            key: "blandStyle",
            value: function blandStyle(column, event) {
                var style = void 0;
                            ...
                            if (!badPoint) {
                                ...
                                points.push(
                                    _react2.default.createElement("circle", {
                                        key: column + "-" + key,
                                        cx: x,
                                        cy: y - _this2.props.scatterPointsOffsetY,
                                        r: radius,
                                        style: style,
                    ...
                    try {
                        var _loop2 = function _loop2() {
                            ...
                            var badPoint =
                                _underscore2.default.isNull(value) ||
                                _underscore2.default.isNaN(value);
                            var blandStyle = _this2.blandStyle(column, event);
                            ...
                            if (!badPoint) {
                                ...
                                //allow for custom icons to be used, but only when the value is -1
                                if (_this2.props.icon && value === -1) {
                                    var Icon = _this2.props.icon;
                                    var iconOffsetX = _this2.props.iconOffsetX;
                                    var iconOffsetY = _this2.props.iconOffsetY;
                        ...
                        for (
                            var _iterator4 = series.events()[Symbol.iterator](), _step4;
